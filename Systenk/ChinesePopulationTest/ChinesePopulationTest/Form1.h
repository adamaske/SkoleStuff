...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bindingNavigator1->Size = System::Drawing::Size(632, 25);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(345, 198);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 1;
			this->button1->Text = L"FunTime";
			...
			this->ClientSize = System::Drawing::Size(632, 563);
...
#pragma endregion
	private: System::Void chart1_Click(System::Object^ sender, System::EventArgs^ e) {
		Please sir, may I have just a crumb of bussy? I am starving sir.
	}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		hei jeg heter adam og jeg er avhengig av sperm. Dette har påvirket meg og familien mine på flere måter
			derfor oppsøker jeg nå hjelp. Jeg har lest anmeldsene på google, og de ser veldig lovende ut. 
			Så kjære Rema 1000 dagligleder, kan du hjelpe meg?
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		i want some cock in my ass now pls. I need it now, give me cock now, please give me some cock
			before i cum in my pants, i have to cum inside a cock, let me cum in your eurethra.
			If i cannot cum inside another cock's euretrha I will scream. I am not afraid, I will screem until you
			let me cum inside your euretrha. It will be very emberassing for you, i would know because I have done it
			before. And oh boy let me tell you, it was not a pleasent expereince for either part. 
			Screaming like that makes me feel like im a giant crying cum-baby, but im not a cum-baby. I am a man,
			a big cum-man. So to avoid this whole screaming mess of a situation we have gotten ourselfs into, just
			let me cum in your eurathra and it will all be over. We can both go home to our families after this and 
			forget it ever happend, but I have to cum inside your cock. I have to see my cum inside your euerthra, 
			it should come seeping out of your cock of the next few days, only a little at a time, but somewhat more when you piss
	}
	};
}
